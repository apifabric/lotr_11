...
resourcename="lotr11"  # lower case, only
resourcegroup="lotr11_rg"
...
# git clone https://github.com/apilogicserver/lotr11.git
# cd lotr11
...
az group create --name lotr11_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group lotr11_rg --sku S1 --is-linux
az container create --resource-group lotr11_rg --name lotr11 --image apilogicserver/lotr11:latest --dns-name-label lotr11 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//lotr11.westus.azurecontainer.io:5656'
