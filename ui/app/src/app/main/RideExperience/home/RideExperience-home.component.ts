...
@Component({
  selector: 'RideExperience-home',
  templateUrl: './RideExperience-home.component.html',
  styleUrls: ['./RideExperience-home.component.scss']
})
export class RideExperienceHomeComponent implements AfterViewInit {
