...
@Component({
  selector: 'FoodVendor-home',
  templateUrl: './FoodVendor-home.component.html',
  styleUrls: ['./FoodVendor-home.component.scss']
})
export class FoodVendorHomeComponent implements AfterViewInit {
