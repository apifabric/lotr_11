...
@Component({
  selector: 'Merchandise-home',
  templateUrl: './Merchandise-home.component.html',
  styleUrls: ['./Merchandise-home.component.scss']
})
export class MerchandiseHomeComponent implements AfterViewInit {
